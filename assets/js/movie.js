...
function showCategories(){
	...
	arrCategories.forEach(function (category){ //parametro category se utiliza abajo
		$("#list-categories").append('<div class="form-group"><button onclick="removeElement('+category.id+')" class="btn btn-danger"><i class="fas fa-trash-alt"></i></button> <span>  ' + category.name+'</span></div>')//accede al nombre de la categoria
	})
}
